                ...
                <div class="about-section flex reveal">
                    ...
                    <h1 class="section-title2">EXPERIENCE.</h1>
                        <p class="section-p2 mt">                           
                            Self-taught web developer passionate about 
                            designing and developing web applications. 
                            Completed a web development bootcamp on edX, 
                            gaining valuable skills and knowledge. Secured 
                            an internship with "SinclairLondon," where I 
                            redesigned their Loyalty scheme and page, 
                            contributed to a successful Christmas campaign 
                            that garnered over 100 thousand visitors in a 
                            month, and initiated an SEO strategy. Love for 
                            design fuels my ambition to become a full-stack 
